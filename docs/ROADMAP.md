...
| Artifact lifecycle: show → save → revisit → export | 2–3 | Show, auto-save, Library, copy, export (PDF, Markdown, CSV, PNG, SVG, Mermaid, HTML) done; rename, pin, regenerate planned |
