...
- A native pointer drag that leaves the card closed. Drag commands: the 6 px threshold, wrong-pointer rejection, cancel restoring the position, and the card following Edi (pinned or not; revised 2026-09-13). The card window cannot send drag commands.
