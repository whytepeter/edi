...
The worker selects Pocket’s `fantine` voice as Edi’s local female default. Pocket’s published `alba` embedding is male-pitched (~130 Hz); Fantine measures ~190 Hz. Provider and voice selection belong in Settings later.
